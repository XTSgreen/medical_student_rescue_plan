  ...
  <div class="demo-container">
    ...
    <div class="dual-canvas">
      <div class="canvas-wrap">
        ...
        <div ref="leftCanvasContainer" class="demo-canvas dual" role="img" aria-label="列空间视角画面，展示像空间结构，可用鼠标拖拽旋转视角"></div>
      </div>
      <div class="canvas-wrap">
        <p class="canvas-label">零空间视角 N(A) ⊂ ℝ³（"压缩内核"）</p>
        <div ref="rightCanvasContainer" class="demo-canvas dual" role="img" aria-label="零空间视角画面，展示压缩内核结构，可用鼠标拖拽旋转视角"></div>
      </div>
    </div>
