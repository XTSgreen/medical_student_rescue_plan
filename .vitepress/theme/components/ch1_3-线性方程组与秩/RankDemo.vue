<template>
  <div class="demo-container">
    ...
    <div ref="canvasContainer" class="demo-canvas" role="img" aria-label="矩阵秩几何演示画面，展示维度塌缩效果，可用鼠标拖拽旋转视角"></div>
    ...
    <div class="preset-buttons" role="group" aria-label="预设方案选择">
      ...
      <button :class="{ active: preset === 'rank2' }" :aria-pressed="preset === 'rank2'" @click="setPreset('rank2')">秩 2</button>
      <button :class="{ active: preset === 'rank1' }" :aria-pressed="preset === 'rank1'" @click="setPreset('rank1')">秩 1</button>
      <button :class="{ active: preset === 'rank0' }" :aria-pressed="preset === 'rank0'" @click="setPreset('rank0')">秩 0</button>
    </div>
